 ...
 * to help users who want some examples when deciding what weather values they want to pick. Takes 3
 * props: name (name of weather value being referenced), clicked (T/F based on container's clicked
 * state), and unit (F, days, etc.). Conditional opperator is present in <li> section because names
 * starting with "m" are for monthly average values, which are in an array, and need to be accessed
