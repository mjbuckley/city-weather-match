 ...
 * params if needed), 2) lists the station's name as the link text, and 3) include a className
 * indictating if the station is in props.matches or not (and not if !isActive). Similar but not the
 * same as citystationlink.js.
 */
