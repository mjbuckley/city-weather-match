  ...
  return (
    <div className="about">
      ...
      <Helmet>
        ...
        <meta name="description" content="An explination of where the weather data for the site comes from and how to best understand the search results." />
      </Helmet>
      ...
      <p>The data for this site comes from the <a href="https://www.ncdc.noaa.gov/data-access/land-based-station-data/land-based-datasets/climate-normals/1981-2010-normals-data">NOAA 1981-2010 Climate Normals.</a> This dataset contains weather information from that 30 year period for over 9800 weather stations across the country. There is an overwhelming amount of data collected in the Climate Normals, and my goal for this site was to take a small portion of that data and present it in a simple, searchable, and user friendly format. The pieces of data I chose to include and make searchable were those that I felt would best give a good general sense of a city's typical weather. This is obviously a somewhat subjective choice, and I realize others may have different preferrences. If you want to see data that is not included on the site, just scroll down to the "Suplementary Information" section on any location's detailed info page and you will find a link to all of the raw data for that location.</p>
      ...
      <p>While the search results are accurate, they can occasionally be misleading. Consider a large and geographically diverse city like Los Angeles, where the temperature can vary significantly depending on whether you are by the ocean, far inland, or near the mountains. No matter where a particular LA weather station is located, it cannont possibly be fully representative of the entire city. So, to get the best sense of an area's weather, consider these two suggestions:</p>
      ...
      <ol>
        ...
        <li><span className="about-list-highlight">Look at other weather stations in the same metro area:</span> A metro area is an urban area and its nearby socially and economically related communities. For example, New York City iteself has around 8.5 million residents, but the greater New York City metro area, which includes nearby cities in New Jersey, New York, and Connecticut, contains almost 24 million people. If a city is part of a metro area then you will find a link to other cities in the same metro area in the "Supplementary Information" section. Not all cities belong to a metro area, and occasionally a city will belong to multiple metro areas. Also, while there is an official distinction between <a href="https://en.wikipedia.org/wiki/Metropolitan_statistical_area">Metropolitan</a> and <a href="https://en.wikipedia.org/wiki/Micropolitan_statistical_area">Micropolitan</a> areas, on this site they have been grouped together under the same "metro area" term.</li>
      </ol>
    </div>
  );
}
